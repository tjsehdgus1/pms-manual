    ...
    items: [
      {
        ...
        sub: [
          ...
          { label: '[일반회원] 약관동의',          href: '00_회원가입_사용자.html#s-일반-약관' },
          { label: '[일반회원] 본인인증',          href: '00_회원가입_사용자.html#s-일반-인증' },
          { label: '[일반회원] 회원정보 작성',     href: '00_회원가입_사용자.html#s-일반-정보' },
          { label: '[기업회원] 약관동의',          href: '00_회원가입_사용자.html#s-기업-약관' },
          { label: '[기업회원] 기업 조회/등록',    href: '00_회원가입_사용자.html#s-기업-조회등록' },
          { label: '[기업회원] 기업 조회',         href: '00_회원가입_사용자.html#s-기업-조회' },
          { label: '[기업회원] 공동인증서 인증',   href: '00_회원가입_사용자.html#s-기업-공동인증' },
          { label: '[기업회원] 기업정보 작성',     href: '00_회원가입_사용자.html#s-기업-정보입력' },
          { label: '[기업회원] 본인인증',          href: '00_회원가입_사용자.html#s-기업-인증' },
          { label: '[기업회원] 회원정보 작성',     href: '00_회원가입_사용자.html#s-기업-회원정보' },
        ]
      },
      {
