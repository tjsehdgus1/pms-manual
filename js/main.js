...
const NAV = [
  ...
  },
  {
    ...
    items: [
      {
        label: '00-A. 일반회원 가입 (사용자)',
        href: '00a_일반회원_가입.html',
        role: 'user',
        sub: [
          { label: '회원 유형 선택', href: '00a_일반회원_가입.html#s-가입선택' },
          { label: '약관 동의',     href: '00a_일반회원_가입.html#s-약관동의' },
          { label: '본인인증',      href: '00a_일반회원_가입.html#s-본인인증' },
          { label: '회원정보 작성', href: '00a_일반회원_가입.html#s-회원정보' },
        ]
      },
      {
        label: '00-B. 기업/기관 회원가입 (사용자)',
        href: '00b_기업기관_회원가입.html',
        role: 'user',
        sub: [
          { label: '회원 유형 선택',          href: '00b_기업기관_회원가입.html#s-가입선택' },
          { label: '약관 동의',               href: '00b_기업기관_회원가입.html#s-약관동의' },
          ...
          { label: '소속회원 승인관리',       href: '00b_기업기관_회원가입.html#s-회원관리' },
        ]
      },
      {
      ...
      },
      {
        ...
        sub: [
          ...
          { label: '조정지원금 입력',        href: '09_선정평가_진행_평가위원장.html#s-조정지원금' },
        ]
      },
      {
